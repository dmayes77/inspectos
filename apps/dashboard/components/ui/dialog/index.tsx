...
function DialogContent({
  ...
  a11yTitle = "Dialog",
  a11yDescription = "Dialog content",
  ...
  const resolvedAriaLabelledBy = ariaLabelledBy ?? fallbackTitleId
  const resolvedAriaDescribedBy = ariaDescribedBy ?? fallbackDescriptionId
