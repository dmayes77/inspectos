    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <Badge color="light">Coming soon</Badge>
      ...
      <div className="grid gap-4 md:grid-cols-2">
          ...
          <CardContent className="space-y-3 text-sm">
            {DELIVERY_RULES.map((rule, idx) => (
              <div key={idx} className="flex items-center justify-between rounded-md border px-3 py-2">
                ...
                <Badge color="light">{rule.channel}</Badge>
              </div>
            ))}
        ...
        <Card>
          ...
          <CardContent>
            {connectedChannels === 0 ? (
              <div className="flex flex-col items-center justify-center gap-3 rounded-md border border-dashed p-8 text-center text-sm text-muted-foreground">
