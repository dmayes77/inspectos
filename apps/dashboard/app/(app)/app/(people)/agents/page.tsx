      ...
      return (
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-0.5">
            <Link href={`/app/agents/agencies/${agency.id}`} className="font-medium hover:underline">
              {agency.name}
            </Link>
...
const agentColumns: ColumnDef<Agent>[] = [
  ...
  },
  {
    ...
    cell: ({ row }: { row: AgentRow }) =>
      row.original.agency ? (
        <Link href={`/app/agents/agencies/${row.original.agency.id}`} className="flex items-center gap-2 text-sm hover:underline">
...
function AgentsPageContent() {
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        ...
        actions={
          <div className="flex flex-wrap items-center gap-2">
            {activeTab === "agencies" ? (
              <Button asChild>
                <Link href="/app/agents/agencies/new">
            ...
            {activeTab === "agencies" ? (
              ...
              <Button
                ...
                asChild
              >
                <Link href="/app/agents/agencies/new">Add Agency</Link>
              </Button>
            )}
          </div>
        }
      ...
      <Tabs value={activeTab} onValueChange={(value: string) => router.replace(`/app/agents?tab=${value}`)} className="space-y-4">
