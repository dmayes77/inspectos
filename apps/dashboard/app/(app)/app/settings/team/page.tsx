          ...
          <CardContent className="pt-5">
            <div className="flex items-start justify-between">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href="/app/team"><ArrowRight className="h-4 w-4" /></Link>
              </Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="hover:border-brand-300 transition-colors">
          <CardContent className="pt-5">
            <div className="flex items-start justify-between">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href="/app/settings/roles"><ArrowRight className="h-4 w-4" /></Link>
              </Button>
            </div>
          </CardContent>
        </Card>
          ...
          <ul className="divide-y divide-border">
            {SYSTEM_ROLES.map((role) => (
              <li key={role.name} className="flex items-center justify-between gap-4 py-3 first:pt-0 last:pb-0">
                ...
                <Button variant="ghost" size="sm" asChild>
                  <Link href="/app/settings/roles">View</Link>
                </Button>
              </li>
            ))}
          </ul>
