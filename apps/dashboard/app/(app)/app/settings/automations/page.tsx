      ...
      return (
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs text-muted-foreground">
            ...
            <Badge color="error" className="bg-red-100 text-red-800">
              {stats.failureCount} failures
            </Badge>
            <Button variant="link" asChild>
              <Link href={`/app/workflows/${workflow.id}`}>View definition</Link>
            </Button>
          </div>
        </div>
      );
    ...
    return ruleWorkflows.map((workflow) => (
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-4 text-xs text-muted-foreground">
          ...
          <Button variant="link" asChild>
            <Link href={`/app/workflows/${workflow.id}`}>Edit workflow</Link>
          </Button>
        </div>
      </div>
    ));
          ...
          <CardContent>
            ...
            <div>
              ...
              <Button className="mt-4" asChild>
                <Link href="/app/workflows/new">Open builder</Link>
              </Button>
            </div>
          </div>
          </CardContent>
