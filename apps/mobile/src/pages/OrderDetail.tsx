...
export default function OrderDetail() {
  ...
  const buildChecksForTransition = (
        ...
        <div className="inspector-order">
          ...
          {mapEmbedUrl ? (
            <div className="inspector-map-block">
              <p className="inspector-section-title">Location</p>
              <iframe
          ...
          <p className="inspector-section-title">Inspection Details</p>
          <div className="inspector-meta-cards">
            <div className="inspector-meta-card inspector-meta-card--scheduled">
              <span className="inspector-progress-label">Scheduled</span>
              <strong>{formatScheduleFriendly(order.scheduled_date, order.scheduled_time)}</strong>
            </div>
            <div className="inspector-meta-card inspector-meta-card--client">
              <span className="inspector-progress-label">Client</span>
              <strong>{order.client?.name || 'Not assigned'}</strong>
            </div>
          </div>
          ...
          {isPendingFieldIntake ? (
            <div className="inspector-status-note inspector-secondary-actions inspector-secondary-actions--stacked">
              <IonText color="warning">
                <p>
                  Field Intake is waiting for dispatch deployment. You can edit name/address, but inspection workflow
                  is locked until dispatch deploys this order.
                </p>
              </IonText>
            </div>
          ) : null}
          ...
          <p className="inspector-section-title">Progress</p>
          ...
          <div className="inspector-bottom-actions">
            <IonButton
              ...
              disabled={isPendingFieldIntake || !hasMappableAddress}
            >
              Get Directions
            </IonButton>
            {isPendingFieldIntake ? (
              <IonButton
                expand="block"
                onClick={() => history.push(`/t/${tenantSlug}/order/${order.id}/field-intake`)}
              >
                Edit Field Intake
              </IonButton>
            ) : primaryAction ? (
