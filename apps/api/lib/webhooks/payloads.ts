...
export function buildOrderCreatedPayload(order: any) {
  return {
    order: {
      id: order.id,
      ...
      property: order.property
        ...
        : null,
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      services: order.inspection?.services?.map((service: any) => ({
        id: service.id,
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function buildOrderUpdatedPayload(order: any) {
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function buildOrderCompletedPayload(order: any) {
  return {
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function buildOrderCancelledPayload(order: any) {
  return buildOrderCreatedPayload(order);
}
