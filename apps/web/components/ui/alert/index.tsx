...
const containerStyles: Record<AlertProps["variant"], string> = {
...
const iconStyles: Record<AlertProps["variant"], string> = {
...
function Alert({
  ...
  return (
    <div className={`rounded-xl border p-4 ${containerStyles[variant]}`}>
