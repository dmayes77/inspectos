...
): ColumnDef<Service>[] => [
  {
    ...
    cell: ({ row }) => (
      <div className="flex items-center gap-2">
        <Link
          href={`/app/services/${row.original.serviceId}`}
          ...
          actions={
            can(userRole, "manage_billing", userPermissions) ? (
              <div className="flex flex-wrap gap-2 sm:flex-nowrap">
                <Button asChild>
                  <Link href="/app/services/new?mode=service">
                    <Plus className="mr-2 h-4 w-4" /> Create Service
                  </Link>
                </Button>
                <Button asChild variant="outline">
                  <Link href="/app/services/new?mode=package">
              ...
              <div className="rounded-sm border border-dashed p-10 text-center">
                ...
                {can(userRole, "manage_billing", userPermissions) && (
                  <Button className="mt-4" asChild>
                    <Link href="/app/services/new?mode=service">Create service</Link>
                  </Button>
                )}
              </div>
            ) : (
