  ...
  const handleDelete = () => {
    deleteAgent.mutate(agent.id, {
      onSuccess: () => {
        ...
        router.push("/app/agents?tab=agents");
      },
      onError: (error) => {
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
            {agent.agency ? (
              <Button variant="outline" className="w-full sm:w-auto" asChild>
                <Link href={`/app/agents/agencies/${agent.agency.id}`}>
                  <Building2 className="mr-2 h-4 w-4" /> View agency
                </Link>
              </Button>
            ) : null}
            <Button className="w-full sm:w-auto" asChild>
              <Link href={`/app/agents/agents/${agent.id}/edit`}>
                ...
                {agent.agency ? (
                  <>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2 font-medium">
                          ...
                          <Link href={`/app/agents/agencies/${agent.agency.id}`} className="hover:underline">
                            {agent.agency.name}
                          </Link>
                        </div>
                    ...
                    <Button asChild variant="outline" className="w-full">
                      <Link href={`/app/agents/agencies/${agent.agency.id}`}>Open agency</Link>
                    </Button>
                  </>
                ) : (
                  <>
