  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-4 xl:h-[calc(100vh-13rem)] xl:grid-cols-[240px_360px_minmax(0,1fr)]">
        <div className="min-w-0 space-y-3 rounded-2xl border bg-card p-3 shadow-sm xl:overflow-y-auto">
          <div className="px-1">
        ...
        <div className="min-w-0 h-[70vh] rounded-2xl border bg-card p-3 shadow-sm xl:h-full xl:min-h-0 xl:overflow-hidden xl:flex xl:flex-col">
            ...
            <div className="max-w-full space-y-2">
              {filteredMessages.map((message) => (
                <button
                  ...
                  className={cn(
                    "block w-full max-w-full overflow-hidden rounded-xl border p-3 text-left transition-all hover:shadow-sm",
        ...
        <div className="rounded-2xl border bg-card shadow-sm xl:min-h-0 xl:overflow-hidden">
          {selectedMessage ? (
