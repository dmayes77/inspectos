...
const columns: ColumnDef<Order>[] = [
  {
    ...
    enableHiding: false,
    cell: ({ row }) => (
      <Link href={`/app/orders/${row.original.id}`} className="font-medium hover:underline text-xs">
  ...
  },
  {
    ...
    header: "Property",
    cell: ({ row }) => (
      <Link href={`/app/orders/${row.original.id}`} className="text-xs max-w-xs hover:underline">
