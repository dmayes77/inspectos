...
const createPropertiesColumns = (): ColumnDef<Property>[] => [
  {
    ...
    cell: ({ row }) => (
      <Link
        href={`/app/properties/${row.original.id}`}
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Link
          href={`/app/contacts/${row.original.client.id}`}
    ...
    <ResourceListLayout
      ...
      stats={
        <div className="grid grid-cols-3 gap-3 md:grid-cols-6">
          ...
          <StatCard label="Single-Family" value={stats.singleFamily} />
          <StatCard label="Condo / Townhome" value={stats.condoTownhome} />
          <StatCard label="Multi-Family" value={stats.multiFamily} />
