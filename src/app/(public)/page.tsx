  ...
  return (
    <AuthRedirect>
      ...
      <section className="relative overflow-hidden pt-32 pb-20">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-orange-100/40 via-background to-background" />
        <div className="mx-auto max-w-6xl px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 text-xl text-muted-foreground">
              The all-in-one platform for home inspectors. Schedule, inspect, report,
              and get paid—all from one beautiful app that works offline.
            </p>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              {
                quote: "InspectOS cut my report time in half. I can complete an inspection and have the report in the client's hands before I leave the property.",
          ...
          <div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                features: [
                  "5 inspectors included",
                  "+$29/mo per additional",
                  "Team scheduling",
              ...
              },
              {
                ...
                features: [
                  "15 inspectors included",
                  "+$25/mo per additional",
                  "API access",
                  "Advanced analytics",
              ...
              <Card
                key={plan.name}
                className={`relative shadow-card ${plan.popular ? "border-primary ring-1 ring-primary" : ""}`}
              >
                {plan.popular && (
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="overflow-hidden rounded-2xl bg-primary px-8 py-16 text-center text-primary-foreground">
            <h2 className="mb-4 text-3xl font-semibold text-white sm:text-4xl">
              Ready to modernize your inspection business?
            </h2>
            <p className="mx-auto mb-8 max-w-xl text-lg text-white/80">
              Join 500+ inspection companies already using InspectOS to save time,
